...
最後提醒，許多歐洲國家為了環保，採取了瓶罐的[環保押金政策](https://xdavidchen.com/zh-tw/snippets/pfand-or-not/)。在這些有實行環保押金的歐洲國家，去超市買塑膠瓶裝或是鋁罐裝（甚至是玻璃瓶裝）的飲料時，結帳的價格通常都已經包含了瓶罐押金的費用。要抵回押金，可以到超市的環保押金專用瓶罐回收器（通常在超市後面的角落），印出來押金金額的單據並在結帳時做使用、或是拿著單據在櫃檯換成現金。
